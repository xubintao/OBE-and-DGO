...
def main(parser_data):
    ...
    save_info(det_metric.coco_evaluator, category_index, "det_record_mAP_0.txt")
...
if __name__ == "__main__":
    ...
    # 数据集的根目录
    parser.add_argument('--data-path', default='E:/deep-learning-for-image-processing-pytorch_object_detection/VOCtrainval_11-May-2012/VOCdevkit', help='dataset root')

    # 训练好的权重文件
    parser.add_argument('--weights-path', default='./pth_files_directory/model_359.pth', type=str, help='training weights')
